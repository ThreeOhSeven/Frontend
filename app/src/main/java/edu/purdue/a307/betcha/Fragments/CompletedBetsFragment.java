...
public class CompletedBetsFragment extends Fragment implements OnPageSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_completed_bets, container, false);
        bets = new ArrayList<Bet>();
        selfToken = SharedPrefsHelper.getSelfToken(getContext());
        recyclerView = (RecyclerView)view.findViewById(R.id.recyclerCompBets);
    ...
    public void onPageSelected() {
        ApiHelper.getInstance(getContext()).getMyCompletedBets(new LoginRequest(selfToken)).enqueue(new Callback<Bets>() {
            @Override
            public void onResponse(Call<Bets> call, Response<Bets> response) {
                ...
                betAdapter = new BetAdapter(getActivity(), bets,selfToken, BetAdapterType.COMPLETED);
